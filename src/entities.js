 ...
 * @return void
 */
Entities.prototype.initialize = function(app) {
	this.app = app;
}
 ...
 * @return object
 */
Entities.prototype.load = function(name, options) {
 ...
 *
 */
Entities.prototype._load = function(name, file, options) {
	//Options for loading entities
	_options = {
		cache: true,
		pass: {}
 ...
 * @return object
 */
Entities.prototype.get = function(name, request) {
