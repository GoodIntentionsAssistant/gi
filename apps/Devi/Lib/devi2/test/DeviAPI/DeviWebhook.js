...
/**
 * A server that listens for POST requests from Devi which are issued on
 * special events as specified on their Webhook page. Please refer to that page
 * on how to set everything up.
 *
 * @see http://apidocs.devi.com
 *
 * If the server receives a valid request from Devi the received data is
 ...
 *           added as a pathname to the Webhook URL in your Devi account
...
function DeviWebhook (options) {
	...
	var server = http.createServer(function (request, response) {
		...
		if (request.headers['user-agent'] === 'Devi.com WebHook Validator') {
...
util.inherits(DeviWebhook, EventEmitter);
module.exports = DeviWebhook;